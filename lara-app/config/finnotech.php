...
return [
    ...
    'credentials_token_scopes' => array("facility:shahkar:get","facility:cc-bank-info:get", "facility:card-to-iban:get", "kyc:iban-owner-verification:get", "kyc:iban-owner-birthdate-verification:get"),
