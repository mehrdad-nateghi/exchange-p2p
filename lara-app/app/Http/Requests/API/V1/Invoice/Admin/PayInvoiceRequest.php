...
class PayInvoiceRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'total_transactions_amount' => [
                'required',
                'numeric',
                'min:' . $this->invoice->payable_amount_by_buyer,
            ],
        ];
    }
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'total_transactions_amount' => $this->invoice->payed_transactions_amount,
        ]);
    }
    ...
    public function messages()
    {
        return [
            ...
            'total_transactions_amount.min' => __('validation.insufficient_transaction_amount', [
                'amount' => number_format($this->total_transactions_amount),
                'min' => number_format($this->invoice->payable_amount_by_buyer)
            ]),
        ];
    }
}
