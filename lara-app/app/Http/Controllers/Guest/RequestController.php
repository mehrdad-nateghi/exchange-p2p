...
class RequestController extends Controller
{
     ...
     *                 @OA\Property(property="trade_volume", type="number", format="double", description = "The quantitative measure of the volume or quantity of currency which would be sold or bought in the request." ),
     *                 @OA\Property(property="lower_bound_feasibility_threshold", type="number", format="double", description = "The minimum threshold of the suggested price that must be met before a particular bid can be registered or considered valid."),
     *                 @OA\Property(property="upper_bound_feasibility_threshold", type="number", format="double", description = "The maximum threshold of the suggested price that must be met before a particular bid can be registered or considered valid."),
     *                 @OA\Property(property="acceptance_threshold", type="number", format="double", description = "The minimum threshold of the suggested price that must be met for an automatic bid acceptance to occur."),
     *                 @OA\Property(property="request_rate", type="number", format="double", description = "The cost or price associated with a single unit of currency."),
