...
class RialBankAccountService
{
    private RialBankAccount $model;

    public function __construct(RialBankAccount $model)
    {
        $this->model = $model;
    }
    ...
    public function createResource(RialBankAccount $model): RialBankAccountResource
    {
        return new RialBankAccountResource($model);
    }
